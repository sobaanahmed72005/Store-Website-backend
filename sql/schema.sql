...
CREATE TABLE IF NOT EXISTS products (
  ...
  content_video_title VARCHAR(255),
  content_video_caption VARCHAR(255),
...
-- Lets an admin explicitly choose what a variant-defining attribute (2+ selected options) should
-- display as in the product's Specifications table, since there's no single correct auto-derived
-- value once that attribute has multiple variant options (see migrate-product-spec-overrides.js).
